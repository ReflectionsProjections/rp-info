            ...
            <Container maxW="container.xl">
                ...
                <Box textAlign="center" my="60px">
                    <Text fontSize="sm" lineHeight="1.2" maxW="xl" margin="auto">
                        Partnering with us offers unique visibility and engagement with our audience. Elevate your brand while supporting our mission.
                    </Text>
                </Box>
                <Flex
                    ...
                    width="100%"
                >
                    <Flex bg="rgba(213, 209, 200, 0.5)" minH="xs" py="40px" justifyContent="center" alignItems="center" borderRadius="20px">
                    ...
                    <Flex bg="rgba(188, 204, 203, 0.5)" minH="xs" py="40px" justifyContent="center" alignItems="center" borderRadius="20px">
                        <VStack w="60%" height="100%" justifyContent="space-between">
                    ...
                    <Flex bg="rgba(233, 232, 227, 0.9)" minH="xs" py="40px" justifyContent="center" alignItems="center" borderRadius="20px">
                        <VStack w="60%" height="100%" justifyContent="space-between">
